...
const CharacterCards = (props) => {
  ...
  return (
    <div>
      <Card className={classes.card_root} onClick={() => {
        ...
        />
          <CardContent className={classes.card_content}>
            <Typography style={{ fontFamily: "comicFont", fontSize: "32px", textShadow: "1px 1px #ff0000", }} component="h5" variant="h5">
              {character.name}
            </Typography>
            <Typography variant="subtitle1" style={{ fontSize: "12px" }}>
              {character.description
                ? character.description.length > 170
                  ...
                  : character.description
                : "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Praesentium veniam laborum sint doloribus similique, atque necessitatibus iure esse nostrum. Velit quam reiciendis..."}
            </Typography>
          </CardContent>
        </div>
      </Card>
